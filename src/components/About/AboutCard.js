          ...
          <div className="col-md-8">
            <blockquote className="blockquote mb-0">
              <p style={{ textAlign: "justify" }}>
                ...
                <br />
                I am a Java Full-Stack Developer with 5 years of experiance and holds a <span className="purple">Master's degree in Computer Science</span> from <span className="blue">Saint Louis University. </span>
                <br />
                <br />
